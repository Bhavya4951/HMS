...
<!-- 
<form class="form-inline" action="{{url('/key')}}">
  <div class="form-group">
      
    <label style="margin-right: 10px; font-weight: 500; font-size:20px;  margin-left:420px;" >Enter a Secret key</label>
    <input type="text" class="form-control" id="Secret key" placeholder="Secret key">
  </div>
  
  <button  style="margin-left: 10px; margin-top:10px;"type="submit" class="btn btn-primary mb-2">Confirm Key</button>
</form> -->
